...
public interface IUserService : ITransientService
{
    ...
    Task<UserRoleDetailDto> GetRolesByUserNameAsync(string username, CancellationToken cancellationToken);
    Task<UserPermissionDto> GetPermissionsByUserNameAsync(string username, CancellationToken cancellationToken);
    Task<string> CreateOrUpdateUserRoleAsync(CreateOrUpdateUserRoleRequest request, CancellationToken cancellationToken);
    ...
    Task<UserPermissionDto> GetByUserNameWithPermissionsAsync(string userName, CancellationToken cancellationToken);
