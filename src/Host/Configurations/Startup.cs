namespace TD.KCN.WebApi.Host.Configurations;
...
internal static class Startup
{
    internal static WebApplicationBuilder AddConfigurations(this WebApplicationBuilder builder)
    {
        ...
        builder.Configuration.AddJsonFile("appsettings.json", optional: false, reloadOnChange: true)
                ...
                .AddJsonFile($"{configurationsDirectory}/ldap.json", optional: false, reloadOnChange: true)
                .AddJsonFile($"{configurationsDirectory}/ldap.{env.EnvironmentName}.json", optional: true, reloadOnChange: true)
